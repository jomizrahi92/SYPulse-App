...
- (void)loadView
{
	...
	// Parse
	NSURL *feedURL = [NSURL URLWithString:@"http://sypulse.org/feed"];
    
    //	NSURL *feedURL = [NSURL URLWithString:@"http://feeds.feedburner.com/SyPulse"];
	
    // NSURL *feedURL = [NSURL URLWithString:@"http://feeds.feedburner.com/9To5Mac-MacAllDay"];
